...
class FamilyBDNCard extends Component {
  static propTypes = {
    intl: intlShape.isRequired
  };

  onClick = () => browserHistory.push('/guests-list/family-bdn');
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <CardMedia>
          <img src="img/familyBDN.jpg" className="img-responsive"/>
        </CardMedia>
        <CardActions>
          <FlatButton
            style={{
...
export default injectIntl(FamilyBDNCard);
